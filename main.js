...
document.querySelector(".ancients").addEventListener("click", (e) => {
  ...
  if (e.target.classList.contains("ancients__item")) {
    ...
    if (classes.contains("ancients__item_1")) {
      ancientItem = 0;
      document
        .querySelector(".ancients__item_1")
        .classList.add("ancients__item_active");
    }
    if (classes.contains("ancients__item_2")) {
      ancientItem = 1;
      document
        .querySelector(".ancients__item_2")
        .classList.add("ancients__item_active");
    }
    if (classes.contains("ancients__item_3")) {
      ancientItem = 2;
      document
        .querySelector(".ancients__item_3")
        .classList.add("ancients__item_active");
    }
    if (classes.contains("ancients__item_4")) {
      ancientItem = 3;
      document
        .querySelector(".ancients__item_4")
        .classList.add("ancients__item_active");
    }
  }
...
document
  .querySelector(".difficulty-selection")
...
function showbackgroundImage(random) {
  ...
  } else if (random === 1 && matrix[stage][random] !== 0) {
    gameCardItem.style.backgroundImage = `${bluArray.pop()}`;
    matrix[stage][random] -= 1;
  } else if (random === 2 && matrix[stage][random] !== 0) {
